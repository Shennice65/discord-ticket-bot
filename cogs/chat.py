...
# System instructions to give the bot a persona
        self.system_instruction = (
            ...
            "--- PERSONALITY ---\n"
            "1. You RESPECT tador. tador is one of the best players in ATL, right alongside dororo, bobblonne, and shots. "
            ...
            "4. Luminosity: Shen (Leader, Malaysia), Raphi (Philippines), Asapad (Singapore), Azory (Indonesia), King (Mauritius), Qtek (Cambodia)\n"
