...
categories = {
    ...
    'ladder': ['get_all_player_ranks', 'get_tier_count', 'get_player_rank', 'get_player_by_rank', 'get_global_rank_index', 'update_player_rank', 'get_ranked_cooldown', 'update_ranked_cooldown', 'reset_ranked_cooldown', 'reset_ranked_cooldown_only', 'get_obs_cooldown', 'update_obs_cooldown', 'reset_obs_cooldown', '_bulk_reassign_ranks', 'unrank_player', '_get_unrank_cooldown_days', 'get_unrank_cooldown', 'is_player_self_unranked', 'remove_player_from_ladder', 'force_set_player_rank', 'process_match_result', 'get_rematch_cooldown'],
